...
//  PeevedPenguins
//
//  Created by Jianchen Tao on 6/9/14.
...
- (void)didLoadFromCCB {
    ...
    // nothing shall collide with our mouseJointNode
...
- (void)touchBegan:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint([_catapultArm boundingBox], touchLocation)) {
        ...
        // transform the world position to the node space to which the penguin will be added (_phsicsNode)
...
- (void)sealRemoved: (CCNode *)seal {
    ...
    // make the particle effect cleran itself up, once it is completed
